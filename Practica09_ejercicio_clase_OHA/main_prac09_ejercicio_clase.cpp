...
void LoadTextures()
{
	...
	t_mad3 = generateTextures("Texturas/mad3.jpg", 0);

	t_caja = generateTextures("Texturas/caja.png", 1);
	t_caja_brillo = generateTextures("Texturas/caja_specular.png", 1);

	t_mad1 = generateTextures("Texturas/madera1.jpg", 0);
	t_mad1_2 = generateTextures("Texturas/madera1_especular.jpg", 0);
	t_mad2 = generateTextures("Texturas/mad2.jpg", 0);
	t_mad2_1 = generateTextures("Texturas/mad2_especular.jpg", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_mad2_1);
...
void display(void)
{
	...
	//derecha ya jala xD
	lightingShader.setInt("material_diffuse", t_mad2);
